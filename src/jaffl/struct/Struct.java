...
import jaffl.FFIProvider;
import jaffl.MemoryIO;
import jaffl.ParameterFlags;
import jaffl.Platform;
import jaffl.util.EnumMapper;
...
public abstract class Struct /*implements Marshallable */{
    ...
    static final class Info {
        ...
        */
        public final void useMemory(jaffl.MemoryIO io) {
            this.io = io;
        }
     ...
     */
    public void useMemory(jaffl.MemoryIO address) {
    ...
    public class Address extends NumberField {
         ...
         */
        public Address() {
            super(Platform.getPlatform().addressSize(), Constants.LONG_ALIGN);
        }
        /**
         ...
         */
        public final jaffl.Address get() {
            long value = getMemoryIO().getAddress(offset);
            return value != 0 ? new jaffl.Address(value) : null;
        }
        
        /**
         * Puts a {@link jafl.Address} value into the native memory.
         */
        public final void set(jaffl.Address value) {
    ...
    public class Pointer extends NumberField {
         ...
         */
        public Pointer() {
            super(jaffl.Address.SIZE, Constants.LONG_ALIGN);
        }
         ...
         * @return a {@link com.googlecode.jffi.Address}.
         */
        public final jaffl.Pointer get() {
...
//            return get().longValue();
    ...
    public class UTFString extends String {
        public UTFString(int length, Charset cs) {
            super(length * 8, 1, length, cs); // FIXME: This won't work for non-ASCII
